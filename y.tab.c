...
{
       0,   103,   103,   106,   107,   108,   109,   112,   113,   114
};
#endif
...
static const char *const yytname[] =
{
  ...
  "variable", "'='", "'('", "')'", "$accept", "stmt", "exp", "term", YY_NULLPTR
};
#endif
...
{
       0,   256,   257,    43,    45,    42,   258,   259,    61,    40,
      41
};
# endif
...
{
      11,    12,    13,     1,     4,     5,     6,    14,     7,    11,
      12,    13,    15,    16,    17,     3,    10
};

static const yytype_int8 yycheck[] =
{
       3,     4,     5,     7,     0,     6,     7,    10,     9,     3,
       4,     5,    11,    12,    13,     8,     7
};
...
{
       0,     7,    12,     8,     0,     6,     7,     9,    13,    14,
      13,     3,     4,     5,    10,    14,    14,    14
};
...
yyreduce:
  ...
  case 2:
#line 103 "sol.y"
                                {(yyval.a_tree) = make_operator(make_variable((yyvsp[-2].a_variable)),'=',(yyvsp[0].a_tree));printf("printtree function\n");printtree ((yyval.a_tree),1);printf("inorder printttree\n");inorder_printtree((yyval.a_tree),1);printf("post-order printttree\n");postorder_printtree((yyval.a_tree),1);}
#line 1394 "y.tab.c"
    break;

  case 3:
#line 106 "sol.y"
                                {(yyval.a_tree) = make_operator((yyvsp[-2].a_tree),'*',(yyvsp[0].a_tree));}
#line 1400 "y.tab.c"
    break;
...
#line 1424 "y.tab.c"
  ...
  case 8:
#line 113 "sol.y"
                                {(yyval.a_tree) = make_variable ((yyvsp[0].a_variable));}
#line 1430 "y.tab.c"
    break;

  case 9:
#line 114 "sol.y"
                                {(yyval.a_tree) = make_number((yyvsp[0].a_number));}
#line 1436 "y.tab.c"
    break;
